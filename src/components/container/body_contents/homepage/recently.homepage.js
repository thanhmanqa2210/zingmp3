  ...
  return (
    <div className="recently">
      <div className="recently-title">
        <div className="title-name">Gần Đây</div>
      ...
      <div className="list-song">
          ...
          <div className="song-item">
              <div className="img-song"><img src={listRecentlys[5].imgSong} alt="" /></div>
              <p title={listRecentlys[5].title} className="song-title">{listRecentlys[5].title}</p>
          </div>
          <div className="song-item">
              <div className="img-song"><img src={listRecentlys[6].imgSong} alt="" /></div>
              <p title={listRecentlys[6].title} className="song-title">{listRecentlys[6].title}</p>
          </div>
      </div>
    </div>
  );
